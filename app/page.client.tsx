...
export default function HomePageClient({ searchParams }: HomePageClientProps) {
  ...
  useEffect(() => {
    setMounted(true);
    const sidebarParam = typeof searchParams?.sidebar === 'string' ? searchParams.sidebar : null;
    const userToken = typeof searchParams?.user_token === 'string' ? searchParams.user_token : null;
  ...
  useEffect(() => {
    ...
    const urlParam = typeof searchParams?.sidebar === 'string' ? searchParams.sidebar : null;
